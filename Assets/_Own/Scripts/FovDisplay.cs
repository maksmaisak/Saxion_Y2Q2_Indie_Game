...
public class FovDisplay : MonoBehaviour
{
    ...
    [SerializeField] FovInfo _fov = new FovInfo {maxAngle = 30f, maxDistance = 30f};
    [SerializeField] LayerMask scanLayerMask = Physics.DefaultRaycastLayers;
    ...
    private void GenerateMesh()
    {
        ...
        for (int i = 0; i < numBaseRays; ++i, rotation *= increment)
        {
            ...
            RaycastHit hit;
            if (Physics.Raycast(ray, out hit, fov.maxDistance, scanLayerMask))
            {
